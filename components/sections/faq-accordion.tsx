...
const defaultFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes, most clients do within 30 to 60 days. The Starter gives you the foundation; the Retainer runs your growth engine every month. You only upgrade when you're ready for consistent lead flow.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our systems are designed for the Zambian market, but we're occasionally open to regional clients in Southern Africa. Reach out for a discovery call and we'll tell you honestly if we're a fit.",
  },
];
